...
namespace UserInterface
{
    ...
    {
        static string filtersFileAddress = @"E:\Диплом\WorkingDirectory\Filters.txt";
        public static bool CheckFilter(string filter)
        {
            HashSet<string> set = new HashSet<string>();

            using (System.IO.StreamReader file = new System.IO.StreamReader(filtersFileAddress))
            {
                string line;
        ...
        public static string ParseNetData(string data)
        {
            ...
            //str.Append(String.Format("packet_length: {0}\r\n", data[0]));
